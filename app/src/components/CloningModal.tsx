...
export default function CloningModal({ open, onClose, initialMethod }: Props) {
  ...
  return (
    <div className={closing ? 'modal-backdrop closing' : 'modal-backdrop'} onAnimationEnd={onAnimationEnd} ref={backdropRef} onClick={handleBackdropClick} onKeyDown={handleKeyDown} tabIndex={-1}>
      <div className="modal-dialog cln-modal" role="dialog" aria-modal="true" aria-labelledby="cloning-modal-title">
        {/* Header */}
        <div className="modal-header">
          <h3 className="modal-title" id="cloning-modal-title">In-Silico Cloning</h3>
